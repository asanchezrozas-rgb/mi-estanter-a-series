...
Este archivo registra, para cada serie que Claude añade o modifica en `index.html`,
exactamente de dónde salió cada dato (sinopsis, reparto, creador/a, plataforma,
año, temporadas). Objetivo: que cualquier dato de una ficha se pueda verificar
contra su fuente original, sin nada inventado ni asumido.

Formato por entrada:

## <Título de la serie>
- Añadida/actualizada: <fecha>
- Año / temporadas: <fuente y URL>
- Género: <fuente y URL>
- Sinopsis: <fuente y URL>
- Creador/a: <fuente y URL>
- Reparto principal: <fuente y URL>
- Disponible en España: <fuente y URL, fecha de verificación>

---

## Karol G: Mañana Fue Bonito
- Añadida: 2026-08-24
- Año / temporadas: documental de 2025 (formato película, no serie por temporadas) — [Netflix Tudum](https://www.netflix.com/tudum/articles/karol-g-tomorrow-was-beautiful-documentary-release-date-news), [IMDb](https://www.imdb.com/title/tt36617085/)
- Género: Documental · Música — [IMDb](https://www.imdb.com/title/tt36617085/)
- Sinopsis: adaptada de la sinopsis oficial — [Netflix Tudum](https://www.netflix.com/tudum/articles/karol-g-tomorrow-was-beautiful-documentary-release-date-news)
- Creador/a (dirección): Cristina Costantini — [Billboard](https://www.billboard.com/espanol/cultura-entretenimiento/cristina-costantini-karol-g-documental-manana-fue-muy-bonito-1235967929)
- Reparto principal: Karol G (documental, no hay reparto actoral) — [Netflix](https://www.netflix.com/title/81909018)
- Disponible en España: Netflix — verificado 2026-08-24 vía [Netflix](https://www.netflix.com/title/81909018)

## Selena: la serie
- Añadida: 2026-08-24
- Año / temporadas: 2020-2021, 2 partes de 9 episodios cada una — [Wikipedia ES](https://es.wikipedia.org/wiki/Selena:_la_serie)
- Género: Drama · Música (clasificación propia, basada en la sinopsis oficial)
- Sinopsis: adaptada de la sinopsis oficial — [Wikipedia ES](https://es.wikipedia.org/wiki/Selena:_la_serie)
- Creador/a: Moisés Zamora (guionista principal) — [Wikipedia ES](https://es.wikipedia.org/wiki/Selena:_la_serie)
- Reparto principal: Christian Serratos, Ricardo Chavira, Noemi González — [Wikipedia ES](https://es.wikipedia.org/wiki/Selena:_la_serie)
- Disponible en España: Netflix — [Wikipedia ES](https://es.wikipedia.org/wiki/Selena:_la_serie), [Netflix](https://www.netflix.com/title/81022733)

## Hasta que te conocí
- Añadida: 2026-08-24
- Año / temporadas: 2016, miniserie de 1 temporada (13 episodios) — [Wikipedia ES](https://es.wikipedia.org/wiki/Hasta_que_te_conoc%C3%AD_(serie_de_televisi%C3%B3n))
- Género: Drama · Música (clasificación propia, basada en la sinopsis oficial)
- Sinopsis: adaptada de la sinopsis oficial — [Wikipedia ES](https://es.wikipedia.org/wiki/Hasta_que_te_conoc%C3%AD_(serie_de_televisi%C3%B3n))
- Creador/a: Alejandro Aimetta — [Wikipedia ES](https://es.wikipedia.org/wiki/Hasta_que_te_conoc%C3%AD_(serie_de_televisi%C3%B3n))
- Reparto principal: Julián Román, Carlos Yorvick, Dolores Heredia — [Wikipedia ES](https://es.wikipedia.org/wiki/Hasta_que_te_conoc%C3%AD_(serie_de_televisi%C3%B3n))
- Disponible en España: Amazon Prime Video / Apple TV (alquiler o compra; no es Netflix original, se emitió por TNT/Telemundo en Latinoamérica) — verificado 2026-08-24 vía listados de [Prime Video](https://www.primevideo.com/-/es/detail/0SXL1G13L89NCK3ERQLT1TMQM2) y [Apple TV](https://tv.apple.com/us/show/hasta-que-te-conoci/umc.cmc.192xoj06e031346j64nel3asp?l=es)

## Luis Miguel: la serie
- Añadida: 2026-08-24
- Año / temporadas: 2018-2021, 3 temporadas (confirmada como la última) — [Wikipedia ES](https://es.wikipedia.org/wiki/Luis_Miguel:_la_serie)
- Género: Drama · Música (clasificación propia, basada en la sinopsis oficial)
- Sinopsis: adaptada de la sinopsis oficial — [Wikipedia ES](https://es.wikipedia.org/wiki/Luis_Miguel:_la_serie)
- Creador/a: Carla González Vargas — [Wikipedia ES](https://es.wikipedia.org/wiki/Luis_Miguel:_la_serie)
- Reparto principal: Diego Boneta, Óscar Jaenada, Camila Sodi — [Wikipedia ES](https://es.wikipedia.org/wiki/Luis_Miguel:_la_serie)
- Disponible en España: Netflix — [Wikipedia ES](https://es.wikipedia.org/wiki/Luis_Miguel:_la_serie)

## The Gilded Age
- Añadida: 2026-08-24
- Año / temporadas: estrenada 2022, 3 temporadas emitidas a fecha de hoy (24-ago-2026); la temporada 4 fue renovada el 28-jul-2025 pero aún no tiene fecha de estreno — probablemente no llegue antes de finales de 2026 o principios de 2027 — [El Comercio](https://elcomercio.pe/mag/fama/que-ver/the-gilded-age-cuando-seria-el-estreno-de-la-temporada-4-de-la-serie-de-hbo-max-nnda-nnlt-noticia/), [Wikipedia ES](https://es.wikipedia.org/wiki/The_Gilded_Age)
- Género: Drama · Época (clasificación propia, basada en la sinopsis oficial)
- Sinopsis: adaptada de la sinopsis oficial — [Wikipedia ES](https://es.wikipedia.org/wiki/The_Gilded_Age)
- Creador/a: Julian Fellowes — [Wikipedia ES](https://es.wikipedia.org/wiki/The_Gilded_Age)
- Reparto principal: Christine Baranski, Cynthia Nixon, Carrie Coon — [Wikipedia ES](https://es.wikipedia.org/wiki/The_Gilded_Age)
- Disponible en España: HBO Max — [Wikipedia ES](https://es.wikipedia.org/wiki/The_Gilded_Age)
- Nota: colocada en "Esperando nueva temporada" a pedido explícito de la usuaria, quien ya vio completas las 3 temporadas emitidas.

## Envidiosa
- Añadida: 2026-08-24
- Año / temporadas: 2024-2026, 4 temporadas — la 4ª y última se estrenó el 27-29 de abril de 2026, cerrando la serie por completo. Nota: la ficha de Wikipedia ES consultada el mismo día aún indicaba "3 temporadas, serie activa", pero varias notas de prensa fechadas en abril de 2026 (más recientes que esa edición de Wikipedia) confirman la 4ª temporada como el cierre de la serie, por lo que se usó ese dato — [LA NACION](https://www.lanacion.com.ar/espectaculos/la-ultima-temporada-de-envidiosa-llego-a-netflix-cuantos-capitulos-son-que-actores-se-sumaron-y-que-nid29042026/), [Nueva Mujer](https://www.nuevamujer.com/espectaculos/2025/12/01/la-serie-que-conquisto-netflix-llega-a-su-fin-asi-sera-el-adios-de-envidiosa/), [Wikipedia ES](https://es.wikipedia.org/wiki/Envidiosa) (reparto/creadora/sinopsis)
- Género: Comedia · Drama (clasificación propia, basada en la sinopsis oficial)
- Sinopsis: adaptada de la sinopsis oficial — [Wikipedia ES](https://es.wikipedia.org/wiki/Envidiosa)
- Creador/a: Carolina Aguirre — [Wikipedia ES](https://es.wikipedia.org/wiki/Envidiosa)
...
- Año / temporadas: 2017 (estreno original en Antena 3), miniserie documental de 4 episodios (1 temporada) — [Hola.com](https://www.hola.com/actualidad/20240509253461/el-caso-asunta-netflix-documental/)
- Género: Documental · Crimen real — clasificación propia según los géneros oficiales listados por Netflix ("Documentales sobre crímenes reales", "Crímenes reales") — [Netflix (ficha oficial)](https://www.netflix.com/es/title/80997225)
- Sinopsis: adaptada de la sinopsis oficial de Netflix ("Esta serie sobre crímenes reales investiga el hallazgo de nuevas pruebas e incógnitas sin resolver de casos famosos, como el asesinato de Asunta Basterra Porto") y del detalle de "testimonios inéditos" — [Netflix (ficha oficial)](https://www.netflix.com/es/title/80997225), [Infobae](https://www.infobae.com/espana/2024/04/29/operacion-nenufar-el-documental-de-netflix-sobre-el-caso-asunta-con-testimonios-ineditos-de-rosario-porto-y-alfonso-basterra/). Se agregó además una sinopsis larga propia (EXTRA_SYNOPSIS) para evitar que el sitio le añadiera automáticamente la frase genérica de relleno que usa para género "crimen" ("la tensión crece capítulo a capítulo"), poco adecuada para un documental sobre un crimen real; esa sinopsis larga incluye el dato, también de Infobae, de que el episodio final repasa las deliberaciones del jurado.
- Creador/a (dirección): Elías León Siminiani — [Hola.com](https://www.hola.com/actualidad/20240509253461/el-caso-asunta-netflix-documental/), [Hipertextual](https://hipertextual.com/cine-television/el-caso-asunta-operacion-nenufar-documental-netflix/). Nota: Infobae menciona también a Ramón Campos junto a Siminiani, pero ese artículo se centra sobre todo en la serie dramatizada de 2024 (que Campos sí produce); el resto de fuentes consultadas atribuyen la dirección del documental de 2017 solo a Siminiani, así que se usó ese dato como principal.
- Reparto principal: no aplica (documental, sin reparto actoral); incluye material de archivo inédito y declaraciones de Rosario Porto y Alfonso Basterra — [Infobae](https://www.infobae.com/espana/2024/04/29/operacion-nenufar-el-documental-de-netflix-sobre-el-caso-asunta-con-testimonios-ineditos-de-rosario-porto-y-alfonso-basterra/)
...
ChatGPT, sin este registro de fuentes. Si se quiere, se pueden ir re-verificando
contra fuentes oficiales bajo pedido, serie por serie._
